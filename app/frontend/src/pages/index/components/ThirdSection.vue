<template>
  <div class="container py-4">
    <h1 class="text-center">
      Преимущества зефирной глины<br />Camelia Flowers Soft
    </h1>
    <div class="row py-4">
      <div class="col-md-6 pb-3 order-md-last">
        <img
          height="300px"
          class="border shadow rounded-lg mx-auto d-block"
          src="../assets/features/composition1.jpg"
          alt="Композиция"
        />
      </div>
    ...
    <div class="row py-4">
      <div class="col-md-6 pb-3">
        <img
          height="300px"
          class="border shadow rounded-lg mx-auto d-block"
          src="../assets/features/composition2.jpg"
          alt="Композиция"
        />
      </div>
